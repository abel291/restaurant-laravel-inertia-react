        ...
        <>
            ...
            <div className="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
                <div className="fixed top-0 right-0 px-6 py-4 sm:block">
                    {props.auth.user ? (
                        <Link href={route('dashboard.home')} className="text-sm text-gray-700 underline">
                            Dashboard
                        </Link>
                    ) : (
                        <>
                            ...
                            <div className="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                                ...
                                <div className="ml-12">
                                    <div className="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        ...
                                        <Link href="https://forge.laravel.com" className="underline">
                                            Forge
                                        </Link>
                                        ,{' '}
                                        <Link href="https://vapor.laravel.com" className="underline">
                                            Vapor
                                        </Link>
                                        ,{' '}
                                        <Link href="https://nova.laravel.com" className="underline">
                                            Nova
                                        </Link>
                                        , and{' '}
                                        <Link href="https://envoyer.io" className="underline">
                                            Envoyer
                                        </Link>{' '}
                                        help you take your projects to the next level. Pair them with powerful open
                                        source libraries like{' '}
                                        <Link href="https://laravel.com/docs/billing" className="underline">
                                            Cashier
                                        </Link>
                                        ,{' '}
                                        <Link href="https://laravel.com/docs/dusk" className="underline">
                                            Dusk
                                        </Link>
                                        ,{' '}
                                        <Link href="https://laravel.com/docs/broadcasting" className="underline">
                                            Echo
                                        </Link>
                                        ,{' '}
                                        <Link href="https://laravel.com/docs/horizon" className="underline">
                                            Horizon
                                        </Link>
                                        ,{' '}
                                        <Link href="https://laravel.com/docs/sanctum" className="underline">
                                            Sanctum
                                        </Link>
                                        ,{' '}
                                        <Link href="https://laravel.com/docs/telescope" className="underline">
                                            Telescope
                                        </Link>
                                        , and more.
                                    </div>
                    ...
                    <div className="flex justify-center mt-4 sm:items-center sm:justify-between">
                        <div className="text-center text-sm text-gray-500 sm:text-left">
                            <div className="flex items-center">
                                ...
                                <Link href="https://laravel.bigcartel.com" className="ml-1 underline">
                                    Shop
                                </Link>
                                ...
                                <Link href="https://github.com/sponsors/taylorotwell" className="ml-1 underline">
                                    Sponsor
                                </Link>
                            </div>
                        </div>
